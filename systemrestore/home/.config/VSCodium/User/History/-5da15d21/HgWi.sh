...
echo
echo ">> Backing up all shell dot files"
echo
installed_dir=$HOME
...
echo
sudo cp -arf /etc/systemrestore/scripts* $installed_dir/systembackup/scripts/
