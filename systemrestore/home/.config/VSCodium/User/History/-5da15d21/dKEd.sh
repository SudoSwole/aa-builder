...
sleep 2
sudo chown -R $currentuser $installed_dir/systembackup/scripts/
sudo chmod 755 -R $installed_dir/systembackup
#sudo install -C -o $currentuser -m 755 /etc/skel/systemrestore/scripts/* $installed_dir/systembackup/scripts/
sleep 2
print_status ">>... Making a list of all installed applications"
### Make a copy of our installed apps
installed_apps > $installed_dir/systembackup/scripts/pkgs/$now-packagelist.txt
