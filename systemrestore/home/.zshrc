...
plugins=(git archlinux zsh-autosuggestions history)
...
alias updateall='sudo pacman -Syyu ; yay -Syyu ; paru -Syyu'
alias udpate='sudo pacman -Syyu'
alias pacsearch='sudo pacman -Ss'
alias parusearch='paru -Ss'
alias yaysearch='yay -Ss'
alias chaoticlist='sudo pacman -Syl chaotic-aur | less'

# paru as aur helper - updates everything
alias pupdate="paru -Syu --noconfirm"
...
alias whichvga="lspci | grep VGA"

### Plasma Konsave backup
alias plasmabkp="konsave -s kde -f" 
alias plasmarst="konsave -a kde"
alias lattebkp="konsave -s latte -f" 
alias latterst="konsave -a latte"
...
alias regeninitram="sudo mkinitcpio -P"
...
#snapper aliases
alias snaplist="snapper -c config list"
...
source /home/mxviii/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
